    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-xl shadow-lg border border-border p-8">
          <h2 className="text-lg font-semibold text-foreground mb-6">Staff Login</h2>
          {error && (
            <div 
              role="alert" 
              aria-live="polite"
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label htmlFor="staff-email" className="block text-sm font-medium text-foreground mb-1.5">
                Email
              </label>
              <input
                id="staff-email"
            ...
            <div>
              <label htmlFor="staff-password" className="block text-sm font-medium text-foreground mb-1.5">
                Password
              </label>
              <input
                id="staff-password"
          ...
          <p className="text-center text-xs text-muted-foreground mt-6">
            Admin?{" "}
            <Link to="/" className="text-primary hover:underline">Login here</Link>
          </p>
        </div>
      </div>
    </div>
